# 1. WAP to show the table from 2-10 using while, for loop and range function
...
while(True):
    ...
    if(i==11):
        break;
print("\n");
# 2. Compare three numbers and  show  smallest and biggest number
...
# 3. Find average of user given array
...
for i in range(n):
    ...
    arr.append(a);
    avg+=arr[i];
print("Average is:",avg/(len(arr)));

# 4. Use all datatype avaliable in python as a variable,  assign values to variables  and perform valid operation associated with it
